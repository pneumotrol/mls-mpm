//! Simulation of particles falling under gravity using MLS-MPM.
//!
//! This example demonstrates:
//! - Initializing a large number of particles with random positions.
//! - Applying a global acceleration field (gravity) to the background grid.
//! - Using sticky boundary conditions to contain the particles within the domain.
...
fn main() -> Result<()> {
    ...
    let filepath_base = "debug/gravity";
    ...
    println!("Launching gravity simulation...");
