//! Simulation of a central explosion (radial expansion) using MLS-MPM with integer atomics.
//!
//! This example is identical to `explosion.rs` but demonstrates the use of scaled integer atomics
