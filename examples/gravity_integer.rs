//! Simulation of particles falling under gravity using MLS-MPM with integer atomics.
//!
//! This example is identical to `gravity.rs` but demonstrates the use of scaled integer atomics
//! for the Particle-to-Grid (P2G) phase. This provides a fallback for hardware that
//! does not support floating-point atomic additions.
...
fn main() -> Result<()> {
    ...
    let filepath_base = "debug/gravity_integer";
    ...
    println!("Launching gravity simulation (integer atomics)...");
